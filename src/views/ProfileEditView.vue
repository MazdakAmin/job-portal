<template>
    <AppLayout>
        <div class="flex-grow p-6 overflow-y-auto flex">
            <!-- Sidebar Start (on the left) -->
            <aside class="py-4 w-1/4 md:block">
                <div class="sticky flex flex-col gap-2 p-4 text-sm border-r border-indigo-100 top-12">
                    <h2 class="pl-3 mb-4 text-2xl font-semibold">Settings</h2>
                    <button class="flex items-center px-3 py-2.5 font-bold bg-green-700 text-white border rounded-full">
                        Public Profile
                    </button>
                </div>
            </aside>
            ...
            <!-- Form Start (on the right) -->
            <div class="w-3/4 px-6 pb-8 mt-8 sm:max-w-xl sm:rounded-lg">
                <h2 class="pl-6 text-2xl font-bold sm:text-xl">Public Profile</h2>
                <div class="grid max-w-2xl mx-auto mt-8">
                    <!-- Profile Picture Section -->
                    <form action="">
                        <div class="flex flex-col items-center space-y-5 sm:flex-row sm:space-y-0" v-if="!info">
                            ...
                            <div class="flex flex-col space-y-5 sm:ml-8">
                                ...
                                <input type="file" accept="image/*" id="fileInput" @change="handleImageUpload"
                                    class="hidden" />
                        ...
                        <div class="items-center mt-8 sm:mt-14 text-[#202142]">
                            ...
                            <div class="mb-2 sm:mb-6">
                                ...
                                <input type="email" id="email"
                                    class="bg-green-50 border border-green-300 text-indigo-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5"
